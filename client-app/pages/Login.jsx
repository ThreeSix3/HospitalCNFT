...
export default function Login({ onLayout, setToken }) {
    ...
    return (
        <View style={styles.container} onLayout={onLayout}>
            <Header />
            <Animated.View style={[{ position: 'absolute', backgroundColor: 'rgba(0, 0, 0, 0.7)', width: '100%', height: Dimensions.get("window").height+100, zIndex: 2, display: errorVisible ? 'flex' : 'none', justifyContent: 'center', alignItems: 'center' }, opacityBoxErrorVisible]}>
                <View style={{ width: '85%', height: '35%', backgroundColor: 'white', borderRadius: 30, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 10 }}>
                    <View style={{ position: 'absolute', left: '90%', bottom: '90%' }}>
                        <TouchableOpacity onPress={() => { hide(); }}>
                            <Image source={require('../assets/images/cerrarNegro.png')} style={{ width: 25, height: 25 }} />
                        </TouchableOpacity>
                    </View>
                    <Image source={require('../assets/images/cerrar.webp')} style={{ width: 100, height: 100 }} />
                    <Text style={{ fontFamily: 'Montserrat-Bold', fontSize: 35 }}>Error</Text>
                    <Text style={{ fontFamily: 'Montserrat', fontSize: 20, marginTop: 20 }}>Los datos son incorrectos</Text>
